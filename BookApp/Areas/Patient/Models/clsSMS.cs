...
namespace WebApp.Areas.Patient.Models
{
    public class clsSMS
    {
        ...
        public SerialPort OpenPort(string p_strPortName, int p_uBaudRate, int p_uDataBits, int p_uReadTimeout, int p_uWriteTimeout)
        {
            ...
            {
                throw ex;
                //MessageBox.Show("Modem GMS đang bị phần mềm khác đang kết nối, vui lòng kết nối lại sau!", "Thông Báo!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        public bool sendMsg(SerialPort port, string PhoneNo, string Message, int timeout)
        {
            ...
            try
            {
                ...
                recievedData = ExecCommand(port, "AT+CMGF=1", 300, "Failed to set message format.");
                ExecCommand(port, "AT+CSCS=\"GSM\"", 300, "Failed to set message format.");
                String command = "AT+CMGS=\"" + PhoneNo + "\"";               
